import{s as B,m as o,C as a,a as A,F as E,j as C,T as d,A as l,r as i,R as c}from"./index.f89fb69d.js";import{L as p,C as m,T as n}from"./layouts.fe9b2793.js";import{B as F}from"./index.42cb61a3.js";import{R as h}from"./index.4e0ed28d.js";import"@firebase/app";import"@firebase/app-compat";const x=B(o.a)`
  cursor: pointer;
  padding: 24px 10px;
  display: flex;
...
`,q=[{id:1,question:"\uC804\uD615\uACB0\uACFC\uB294 \uC5B8\uC81C \uC54C \uC218 \uC788\uB098\uC694?",answer:`\uC9C0\uC6D0\uAE30\uAC04, \uBA74\uC811\uAE30\uAC04\uC774 \uC885\uB8CC\uB41C \uD6C4 \uD569\uACA9/\uBD88\uD569\uACA9 \uC5EC\uBD80\uC5D0 \uAD00\uACC4\uC5C6\uC774 \uC77C\uC8FC\uC77C \uC548\uC5D0 \uC774\uBA54\uC77C\uB85C \uC5F0\uB77D\uC744 \uB4DC\uB9AC\uACE0 \uC788\uC2B5\uB2C8\uB2E4.
...
GDG, \uD0C0 \uB300\uD559 GDSC\uC640 \uC5F0\uD569\uD558\uC5EC \uC9C4\uD589\uD558\uB294 \uC774\uBCA4\uD2B8\uB97C \uAE30\uD68D, \uC8FC\uCD5C\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.`}],R=()=>A(E,{children:[C(h,{title:"\uC790\uC8FC \uBB3B\uB294 \uC9C8\uBB38",description:"\uC790\uC8FC \uBB3B\uB294 \uC9C8\uBB38"}),C(F,{color:"green"}),C(p,{children:A(m,{children:[C(n,{}),C(d,{children:"\uC790\uC8FC \uBB3B\uB294 \uC9C8\uBB38"}),C(n,{}),C(l,{children:q.map((u,D)=>i.exports.createElement($,{...u,key:D}))}),C(n,{})]})})]}),S=({question:u,answer:D})=>{const[e,t]=i.exports.useState(!1);return A(o.div,{children:[C(x,{animate:e?"hovered":"unHover",isOpen:e,onClick:()=>{t(!e)},children:A(f,{children:[C(z,{}),u]})}),e&&C(g,{exit:{opacity:0,transition:{duration:.3}},animate:{opacity:1,transition:{duration:.3}},initial:{opacity:0},children:D.split(`
`).map((r,s)=>C(w,{children:r},s))}),C(y,{})]})},$=c.memo(S);export{R as default};
