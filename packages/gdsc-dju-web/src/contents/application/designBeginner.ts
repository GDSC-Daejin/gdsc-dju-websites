...
export const designBeginnerForm: FormElementsType<keyof FormValue> = {
  name: {
    type: 'INPUT',
    label: '이름(실명)',
    placeholder: '김구글',
  ...
  question1: {
    type: 'TEXT_AREA',
    label: designBeginnerApplication.question1,
    placeholder:
  ...
  question2: {
    type: 'TEXT_AREA',
    label: designBeginnerApplication.question2,
  ...
  question3: {
    type: 'TEXT_AREA',
    label: designBeginnerApplication.question3,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
  ...
  question4: {
    type: 'TEXT_AREA',
    label: designBeginnerApplication.question4,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
  ...
  question5: {
    type: 'TEXT_AREA',
    label: designBeginnerApplication.question5,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
