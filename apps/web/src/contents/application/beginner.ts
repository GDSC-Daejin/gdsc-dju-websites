...
export const beginnerApplication: IApplicationQuestions = {
  question1: '활용할 수 있는 프레임워크, 라이브러리를 알려주세요.',
  question2: '협업 경험이 있다면 자세하게 알려주세요.',
  question3: '어떤 리드가 좋은 리드라고 생각하시는지 알려주세요.',
  question4: '팀원과 갈등상황은 어떻게 해결하시나요?',
  question5: '본인만의 공부방법이 있다면 어떤 것이 있나요?',
};
export const beginnerForm: FormElementsType<keyof FormValue> = {
  name: {
    type: 'INPUT',
    label: '이름(실명)',
    placeholder: '김구글',
  ...
  question1: {
    type: 'TEXT_AREA',
    label: beginnerApplication.question1,
    placeholder:
  ...
  question2: {
    type: 'TEXT_AREA',
    label: beginnerApplication.question2,
  ...
  question3: {
    type: 'TEXT_AREA',
    label: beginnerApplication.question3,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
  ...
  question4: {
    type: 'TEXT_AREA',
    label: beginnerApplication.question4,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
  ...
  question5: {
    type: 'TEXT_AREA',
    label: beginnerApplication.question5,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
