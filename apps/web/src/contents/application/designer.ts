...
export const designerApplication: IApplicationQuestions = {
...
export const designerForm: FormElementsType<keyof FormValue> = {
  name: {
    type: 'INPUT',
    label: '이름(실명)',
    placeholder: '김구글',
  ...
  question1: {
    type: 'TEXT_AREA',
    label: designerApplication.question1,
    placeholder:
  ...
  question2: {
    type: 'TEXT_AREA',
    label: designerApplication.question2,
  ...
  question3: {
    type: 'TEXT_AREA',
    label: designerApplication.question3,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
  ...
  question4: {
    type: 'TEXT_AREA',
    label: designerApplication.question4,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
  ...
  question5: {
    type: 'TEXT_AREA',
    label: designerApplication.question5,
    required: {
      value: true,
      message: '필수 입력 값이에요.',
    },
