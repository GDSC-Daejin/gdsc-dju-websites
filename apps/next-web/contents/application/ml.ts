...
export const mlApplication: IApplicationQuestions = {
...
export const mlForm: FormElementsType<keyof FormValue> = {
  name: {
    type: 'INPUT',
    label: '이름(실명)',
    placeholder: '김구글',
